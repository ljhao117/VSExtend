/*---------------------------------------------------------
 * Copyright (C) Massivehard Corporation. All rights reserved.
 *--------------------------------------------------------*/

/* To demonstrate code actions associated with Diagnostic problems, this file provides a mock diagnostics entries. */

import * as vscode from 'vscode';

/* Code that is used to associated diagnostic entries with code actions. */
 ...
 * This demo diagnostic provider finds all mentions of 'emoji'.
 * @param doc text document to analyze
 * @param emojiDiagnostic diagnostic collection
 */
export function refreshDiagnostics(doc: vscode.TextDocument, emojiDiagnostic: vscode.DiagnosticCollection): void {
    ...
    emojiDiagnostic.set(doc.uri, diagnostics);
}
